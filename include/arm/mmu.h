...
// 8 bit per memory attribute in MAIR_ELx, it can describe 8 memroy attributes, can index it by AttrIndx in page table entry
// I only user the lower 16 bit of MAIR_ELx register,  it is only describe device memory and normal memory which is not cached
